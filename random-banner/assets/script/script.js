jQuery(document).ready(
    function ($) {
        ...
        if (upload_area.length) {
            ...
            $('.add_new_upload, .add_new_script').on(
                'click',
                function (e) {
                    var content_;
                    ...
                    $('.upload_area .file_url_link').each(
                        function () {
        ...
        if ($('.bc_rb_option_save, .bc_rb_popup_save').length) {
            $('.bc_random_banner').on(
                'click',
                '.bc_rb_option_save, .bc_rb_popup_save',
                function (e) {
    ...
    function ($) {
        ...
        $('.category').on(
            ...
            function (e) {
                ...
                var flag = 'no';
                $('.category_items .category_input').each(
                    function () {
                        if ($(this).val().length == 0) {
                            flag = 'yes';
                        }
...
function content_fn_upload(category) {
    var content = '<div class="row single_upload">' +
        ...
        '<div class="row">' +
        '<div class="col-md-6">' +
        '<input type="hidden" name="banner_type" value="upload" />' +
        ...
        '</div>' +
        '<div class="col-md-3 padding_top_10"><div class="input-group">' +
        '<input type="number" name="width" class="form-control width" placeholder="Width in px">' +
        '<span class="input-group-addon" >px</span>' +
        '</div>' +
        '</div>' +
        '<div class="col-md-3 padding_top_10">' +
        '<div class="input-group">' +
        '<input type="number" name="height" class="form-control height" placeholder="Height in px">' +
        '<span class="input-group-addon" >px</span>' +
        '</div>' +
        '</div>' +
        '<div class="col-md-3 padding_top_10">' +
        '<div class="checkbox">' +
        '<label> <input checked type="checkbox" name="automatic" value="checked"  class="automatic"> Theme Based </label>' +
        '</div>' +
        '</div>' +
        '<div class="col-md-3 padding_top_10">' +
        '<div class="input-group">' +
        '<div class="dropdown">' +
        '<select id="category" class="form-control category" name="category">' + category + '</select>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
...
function content_fn_script(category) {
    $content = '<div class="row single_upload">' +
        ...
        '<div class="row">' +
        '<div class="col-md-6">' +
        '<input type="text" name="file_description" class="form-control file_description" placeholder="Title"/>' +
        '</div>' +
        '<div class="col-md-6">' +
        '<div class="input-group">' +
        '<div class="dropdown">' +
        ...
        '<input type="hidden" name="banner_type" value="script" />' +
        '<textarea name="file_url_link" class="file_url_link_textarea form-control" rows="5" placeholder="Please paste the code here"></textarea>' +
        '</div>' +
        '<div class="col-md-3 padding_top_10">' +
        '<div class="row">' +
        '<div class="col-md-12">' +
