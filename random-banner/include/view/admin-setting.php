					...
					<div class="col-md-7 bc_plugin_demo" data-email="<?php echo esc_attr( bc_get_current_user_email() ); ?>">
						<div class="flex table-bordered p-10">
							...
							<div class="text-center">
								<a target="_blank" href="https://www.randombanners.com">
                ...
                <div class="tab-pane p-20 fade" id="post_page">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="bc_rb_insert_post_shortcode p-2">
                                <div class="row bc_rb_check_insert_post p-2">
                                    <div class="col-md-6">
                                ...
                                <div class="row bc_rb_enable_insert_post_shortcode hide p-2">
                                    <div class="col-md-6">
                                    <div class="pt-3">
